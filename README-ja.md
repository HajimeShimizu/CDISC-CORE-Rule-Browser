...
## ダウンロード
CDISC CORE GUIとセットになった状態で提供されています。リリースページ（[こちら](https://github.com/HajimeShimizu/CDISC-CORE-Rule-Browser/releases)）よりダウンロードできます。

## セットアップ方法
1. ダウンロードした圧縮ファイルを展開します。
2. rule_browser.exe ファイルが本ツールになります。
